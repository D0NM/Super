/*****************************************************************************************************
* GP32 SDK Version 1.1 header file : gpgraphic.h                                                     *
*		The latest patch : 22,May,2001                                                             *
*		SDK Developer : Jstar, Achi                                                                *
*		related library : gpgraphic.alf, gpg_ex01.alf                                              *
...
GPGRAPHIC Effect API
	...
	You must import gpg_ex??.alf for using the followings!!!
	
	
CURRENTLY, THE FOLLOWINGS IS ALLOWED
