...
/* MMC INTERFACE */
#ifdef __BIG_ENDIAN
#define rMMCON		(*(volatile unsigned char *)0x15a00003)
#define rMMCRR		(*(volatile unsigned char *)0x15a00007)
#define rMMFCON		(*(volatile unsigned char *)0x15a0000b)
#define rMMSTA		(*(volatile unsigned char *)0x15a0000f)
#define rMMFSTA		(*(volatile unsigned short *)0x15a00012)
#define rMMPRE		(*(volatile unsigned char *)0x15a00017)
#define rMMLEN		(*(volatile unsigned short *)0x15a0001a)
#define rMMCR7		(*(volatile unsigned char *)0x15a0001f)
...
#define rMMCMD0		(*(volatile unsigned char *)0x15a00033)
#define rMMCMD1		(*(volatile unsigned *)0x15a00034)
#define rMMCR16		(*(volatile unsigned short *)0x15a0003a)
#define rMMDAT		(*(volatile unsigned char *)0x15a0003f)
